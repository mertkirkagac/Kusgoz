...
let myValidators = class myValidators {
    ...
    static passwordConfirmingForReset(c) {
        if (!c.parent || !c) {
            return;
        }
...
let LoginPage = class LoginPage {
    constructor(alertController, fb, authenticationService, storage, toastr, navCtrl) {
    ...
    onSubmit() {
        this.authenticationService.getToken(this.editLF.Tc.value, this.editLF.password.value).subscribe((data) => {
